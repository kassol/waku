                ...
                "tools": [
                    ...
                    },
                    {
                        ...
                        "inputSchema": {"type":"object","properties":{"operation":{"oneOf":[
                            ...
                            {"type":"object","properties":{"type":{"const":"escalate"},"session_id":{"type":"string","format":"uuid"},"request_id":{"type":"string","format":"uuid"},"reason":{"type":"string"},"options":{"type":"array","minItems":1,"maxItems":8,"items":{"type":"object","properties":{"label":{"type":"string"},"impact":{"type":"string"}},"required":["label","impact"],"additionalProperties":false}},"impact":{"type":"string"}},"required":["type","session_id","request_id","reason","options","impact"],"additionalProperties":false},
                            {"type":"object","properties":{"type":{"const":"list"},"session_id":{"type":"string","format":"uuid"}},"required":["type"],"additionalProperties":false},
                            {"type":"object","properties":{"type":{"const":"decideNative"},"session_id":{"type":"string","format":"uuid"},"request_id":{"type":"string","format":"uuid"},"authority_message_id":{"type":"string","format":"uuid"},"response":{"oneOf":[{"type":"object","properties":{"type":{"const":"permission"},"option_id":{"type":"string"}},"required":["type","option_id"],"additionalProperties":false},{"type":"object","properties":{"type":{"const":"userInput"},"answers":{"type":"array","items":{"type":"object","properties":{"questionId":{"type":"string"},"answers":{"type":"array","items":{"type":"string"}}},"required":["questionId","answers"],"additionalProperties":false}}},"required":["type","answers"],"additionalProperties":false}]}},"required":["type","session_id","request_id","response","authority_message_id"],"additionalProperties":false},

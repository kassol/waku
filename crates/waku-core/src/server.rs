...
impl RequestDispatcher {
    ...
    fn dispatch(
        ...
        if !matches!(request.command, Command::StewardQuery { .. } | Command::StewardInputStatus { .. } | Command::StewardDecision { .. } | Command::StewardLifecycle { .. } | Command::AnswerDecision { .. } | Command::AnswerNativeDecision { .. } | Command::ContinueChild { .. })
...
fn dispatch_steward(
    ...
    let cacheable = !matches!(request.command, Command::StewardQuery { .. } | Command::StewardInputStatus { .. } | Command::StewardDecision { .. } | Command::StewardLifecycle { .. } | Command::AnswerDecision { .. } | Command::AnswerNativeDecision { .. } | Command::ContinueChild { .. });
...
fn handle_request_as(
    ...
    let cacheable = !notification && !matches!(request.command, Command::StewardQuery { .. } | Command::StewardInputStatus { .. } | Command::StewardDecision { .. } | Command::StewardLifecycle { .. } | Command::AnswerDecision { .. } | Command::AnswerNativeDecision { .. } | Command::ContinueChild { .. });
    let session_id = request.session_id;
